...
- [Skill Discovery direct-read real-model study](skill-discovery-direct-read-20260830.md)
- [Skill Discovery real-model confirmation](skill-discovery-confirmation-20260830.md)
...
- [Claude Code Transcript source decisions](claude-code-transcript-source-decisions.md)
- [Notification capability](notification-capability-reference.md)
- [Operation Block and Tool Dialog study](pi-stuff-operation-block-dialog-study-20260829.md)
- [Pi Stuff Tool Activity taxonomy](pi-stuff-tool-activity-taxonomy-20260806.md)
- [Background Work notification UI](work-background-notification-ui-reference.md)
- [BTW UI](work-btw-ui-reference.md)
- [Todo UI](work-todo-ui-reference.md)

## Upstream Package references

- [Subagent completion controls](subagent-completion-controls-20260902.md)
